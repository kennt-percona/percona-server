...
inline srv_row_format_t toku_compression_method_to_row_format(toku_compression_method method) {
    switch (method) {
...
inline toku_compression_method row_format_to_toku_compression_method(srv_row_format_t row_format) {
    switch (row_format) {
