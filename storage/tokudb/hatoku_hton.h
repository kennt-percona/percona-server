...
inline tokudb::sysvars::row_format_t toku_compression_method_to_row_format(toku_compression_method method) {
    switch (method) {
...
inline toku_compression_method row_format_to_toku_compression_method(tokudb::sysvars::row_format_t row_format) {
    switch (row_format) {
...
inline enum row_type row_format_to_row_type(tokudb::sysvars::row_format_t row_format) {
...
inline tokudb::sysvars::row_format_t row_type_to_row_format(enum row_type type) {
#if TOKU_INCLUDE_ROW_TYPE_COMPRESSION
    switch (type) {
...
inline enum row_type toku_compression_method_to_row_type(toku_compression_method method) {
    return row_format_to_row_type(toku_compression_method_to_row_format(method));
}

inline toku_compression_method row_type_to_toku_compression_method(enum row_type type) {
